...
VALUES ( T_ITEM_LIST_PK_SEQ.nextval, '텀블러', 20000, SYSDATE);


INSERT INTO T_ITEM_LIST (no, item_name, price)
VALUES ( T_ITEM_LIST_PK_SEQ.nextval, '모니터', 120000 );
...
INSERT ALL
INTO T_ITEM_LIST VALUES(T_ITEM_LIST_PK_SEQ.NEXTVAL, 'B', 6000, null)
INTO T_ITEM_LIST VALUES(T_ITEM_LIST_PK_SEQ.NEXTVAL, 'C', 7000, null)
SELECT * FROM dual;
*/
